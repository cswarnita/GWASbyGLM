...
#'
#'
#' @description This is the function to calculate and return p-values for each SNPs after testing the association between the Phenotypes and SNP along with their Covairates
#'
